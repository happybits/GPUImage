...
@interface CombinationFilter : GPUImageThreeInputFilter
{
...
@implementation CombinationFilter
...
- (id)init {
    ...
    combinationFilter = [[CombinationFilter alloc] init];
